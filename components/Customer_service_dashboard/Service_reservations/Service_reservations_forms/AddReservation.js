...
function AddReservation() {
  ...
  function handleInputChange(event) {
    ...
    if (
      input == "start" &&
      (change < temporalNewReservation.end || !temporalNewReservation.end)
    ) {
      setTemporalNewReservation({ ...temporalNewReservation, [input]: change });
    } else if (
      input == "end" &&
      (change > temporalNewReservation.start || !temporalNewReservation.start)
    ) {
      setTemporalNewReservation({ ...temporalNewReservation, [input]: change });
  ...
  function addReservation(customerId, newReservation) {
    if (
      ...
      return;
    axios
      .post(`api/customer/addCustomerReservation`, {
        customerId,
    ...
    <div className={styles.MainContainer}>
      ...
      <div className={styles.ModalContainer}>
        ...
        <div className={styles.ReservationInputContainer}>
          ...
          <input
            type="time"
            className={styles.ReservationScheduleInput}
            name="start"
        ...
        <div className={styles.ReservationInputContainer}>
          ...
          <input
            type="text"
            className={styles.ReservationNameInput}
            name="name"
        ...
        <div className={styles.ConfirmReservationContainer}>
          <button
            ...
            onClick={() => addReservation(customerId, temporalNewReservation)}
          >
            {confirmButton}
          </button>
        </div>
