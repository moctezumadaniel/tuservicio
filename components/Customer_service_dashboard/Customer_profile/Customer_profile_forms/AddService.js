...
function AddService() {
  ...
  function addCustomerService(customerId, newService) {
    axios
      .post(`api/customer/addCustomerService`, {
        customerId,
  ...
  return (
    <div className={styles.MainContainer}>
      ...
      <div className={styles.ModalContainer}>
        <div>
          <img src={temporalService.image} className={styles.ServiceImage} />
          <div className={styles.ServiceImageLabelContainer}>
            {/*IMAGE INPUT */}
            <label for="serviceImage" className={styles.ServiceImageLabel}>
              {addImageLabel}
              <input
                type="file"
                accept="image/*"
                ...
                id="serviceImage"
                className={
                  styles.ServiceImageInput
                } /*HIDDENT TO AVOID DEFAULT UGLY LABELS */
        ...
        <div className={styles.ServiceNamePriceDescription}>
          <input
            type="text"
            className={styles.ServiceNamePriceDescriptionInput}
