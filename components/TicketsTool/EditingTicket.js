...
import {
  addItemToCustomerEditingTicketForm,
  ...
  removeItemFromEditingTicketForm,
} from "../../redux/actions/CustomerEditingTicket";
...
function EditingTicket() {
  ...
  const handleNewDescriptionChange = (event) => {
    dispatch(
      changeCustomerEditingTicketFormNewItemDescription(event.target.value)
    );
  };
    ...
    <div className={styles.TicketsToolMainContainer}>
      ...
      <div className={styles.TicketSaveButtonContainer}>
        <button
          ...
          onClick={() =>
            editTicket(customerInformation.customerId, currentTicket)
          }
        >
          {saveTicketButton}
        </button>
