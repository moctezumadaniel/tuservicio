...
export const providersToolEditingPaymentFormReducer = (state=initialProviderEditingPaymentForm, action) =>{
    switch(action.type){
...
export const providersToolEditingCreditFormReducer = (state=initialProviderEditingCreditForm, action) =>{
    switch(action.type){
